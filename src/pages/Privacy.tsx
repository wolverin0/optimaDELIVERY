...
const SECTIONS = [
    ...
    { id: 'recopilacion', title: '2. Recopilación' },
    { id: 'uso', title: '3. Uso' },
    { id: 'compartir', title: '4. Compartir' },
    { id: 'seguridad', title: '5. Seguridad' },
    { id: 'cookies', title: '6. Cookies' },
    { id: 'derechos', title: '7. Sus Derechos' },
    { id: 'retencion', title: '8. Retención' },
    { id: 'menores', title: '9. Menores' },
    { id: 'cambios', title: '10. Cambios' },
            ...
            <div className="max-w-6xl mx-auto px-6 py-12 flex gap-12">
                ...
                <main className="flex-1 min-w-0">
                    ...
                    <div className="prose prose-slate max-w-none">
                        ...
                        <section id="introduccion" className="mb-8 scroll-mt-24">
                        ...
                        <section id="recopilacion" className="mb-8 scroll-mt-24">
                        ...
                        <section id="compartir" className="mb-8 scroll-mt-24">
                        ...
                        <section id="retencion" className="mb-8 scroll-mt-24">
                        ...
                        <section id="menores" className="mb-8 scroll-mt-24">
                        ...
                        <section id="cambios" className="mb-8 scroll-mt-24">
